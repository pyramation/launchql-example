-- Deploy: schemas/vybez_memberships_private/tables/group_memberships_acl/indexes/group_memberships_acls_entity_id_idx to pg
...
BEGIN;
CREATE INDEX group_memberships_acls_entity_id_idx ON "vybez_memberships_private".group_memberships_acl (entity_id) INCLUDE (permissions, is_owner, is_admin);
COMMIT;
