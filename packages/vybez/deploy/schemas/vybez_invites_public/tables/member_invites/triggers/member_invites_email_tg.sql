-- Deploy: schemas/vybez_invites_public/tables/member_invites/triggers/member_invites_email_tg to pg
...
CREATE FUNCTION "vybez_invites_private".member_invites_insert_before_tg()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE FUNCTION "vybez_invites_private".member_invites_insert_after_tg()
RETURNS TRIGGER AS $$
DECLARE
    owner_id boolean;
...
INSERT ON
"vybez_invites_public".member_invites FOR EACH ROW
EXECUTE PROCEDURE "vybez_invites_private".member_invites_insert_after_tg ();
CREATE TRIGGER invite_trigger_send_email AFTER
INSERT ON
"vybez_invites_public".member_invites FOR EACH ROW
EXECUTE PROCEDURE "vybez_invites_private".member_invites_insert_before_tg ();
COMMIT;
