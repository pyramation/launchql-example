-- Deploy: schemas/vybez_memberships_private/trigger_fns/group_memberships_update_acl_tg to pg
...
CREATE FUNCTION "vybez_memberships_private".group_memberships_update_acl_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    v_num_updated int;
