-- Deploy: schemas/vybez_limits_private/trigger_fns/group_member_limits_upd_tg to pg
...
CREATE FUNCTION "vybez_limits_private".group_member_limits_upd_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    limit_ok boolean;
...
BEGIN
    ...
    ELSIF (TG_NARGS = 2) THEN 
        ...
        PERFORM "vybez_limits_private".group_member_limits_dec(
            limitname, old_actor_id
        );
        limit_ok = "vybez_limits_private".group_member_limits_inc(
