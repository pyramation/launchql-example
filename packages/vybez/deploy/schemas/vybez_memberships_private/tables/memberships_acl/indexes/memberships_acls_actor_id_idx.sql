-- Deploy: schemas/vybez_memberships_private/tables/memberships_acl/indexes/memberships_acls_actor_id_idx to pg
...
BEGIN;
CREATE INDEX memberships_acls_actor_id_idx ON "vybez_memberships_private".memberships_acl (actor_id) INCLUDE (permissions, is_owner, is_admin);
COMMIT;
