-- Deploy: schemas/vybez_status_private/trigger_fns/tg_achv_tgl_bool to pg
...
CREATE FUNCTION "vybez_status_private".tg_achv_tgl_bool ()
  RETURNS TRIGGER
  AS $$
DECLARE
  is_true boolean;
...
LANGUAGE 'plpgsql'
VOLATILE;
GRANT EXECUTE ON FUNCTION "vybez_status_private".tg_achv_tgl_bool TO authenticated;
COMMIT;
